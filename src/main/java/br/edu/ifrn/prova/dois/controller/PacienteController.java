...
import br.edu.ifrn.prova.dois.repository.PacienteRepository;
...
public class PacienteController {
    ...
    @Transactional
    @PostMapping
    public ResponseEntity<Object> cadastrar(@RequestBody @Valid Paciente paciente, UriComponentsBuilder uriBuilder) {
